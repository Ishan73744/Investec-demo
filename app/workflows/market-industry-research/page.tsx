...
import { industries, marketTrendData, defaultMarketData } from "@/lib/workflow/market-research-data"
...
export default function MarketIndustryResearchPage() {
  ...
  const generateFinalInsights = () => {
    ...
    setTimeout(() => {
      ...
      // IMPORTANT: Set active customization ID to null to remove any customization boxes
      setActiveCustomizationId(null)

      setIsAnalysisComplete(true)

      // Get market data for the selected industry or default to quick-commerce
      const industryId = selectedIndustry?.id || "quick-commerce"
      const marketData = marketTrendData[industryId] || marketTrendData["quick-commerce"] || defaultMarketData

      console.log("Generating final report with market data:", marketData)
      ...
      workflowEngine.addMessage(
        "system",
        <div className="space-y-4">
          <p className="text-[#001742]">Your industry pre-screen is ready!</p>
          <MarketReport
